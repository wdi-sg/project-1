...
function jump () {
  ...
  circle.style.backgroundImage = "url('https://github.com/karl-x/project-1/blob/gh-pages/img/skatejump2.png')"
  canJump = false
}
function drop () {
  circle.style.top = 520 + 'px'
  circle.style.backgroundImage = "url('https://github.com/karl-x/project-1/blob/gh-pages/img/skating.gif')"
}
