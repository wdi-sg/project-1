...
var upgradedEquipment= {name:"upgraded",cost:200,des:"More equipment like scythes and ploughs to make life easier -$200",res:"as you invested more money in equipment you got better yields"}
...
var poorHarvest={premium:1.5,type:"a poor harvest",modifier:0.05,des:"The amount of crop output is far lower than expected, but hey, it could have been worse."}
var normalHarvest={premium:1,type:"a normal harvest",modifier:1.0,des:"Crop yields are average compared to previous years. It has been a mundane year with a mediocre harvest."}
...
var failure={type:"lose",des:"Due to either extreme bad luck or poor purchasing decisions, you lost more money than you spent. Perhaps next year will be a better year for you. Better luck next time!"}
var meh={type:"earn",des:"You have made more money than you spent, but just barely. At least you did not lose any money, and you can always try again. Perhaps next year will be a better year for you."}
var success={type:"earn",des:"You have managed to turn a substantial profit from your investments. Over time, if you keep up with this performance, you just might become a wealthy farmer!"}
var champ={type:"earn",des:"Amazing! You not only turned a spectacular profit, you more than doubled your initial sum. Word of your success has spread all over the country and your name is known far and wide. Well done, there can't be a better outcome than this!"}

function appraisal(){

		if(finalScore<0){return failure;
		}else if(finalScore<200){return meh;
		}else if (finalScore<2000) {return success;
		}else{return champ;
